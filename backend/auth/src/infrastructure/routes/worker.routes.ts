...
router.post("/create", upload.single("image"), (req, res, next) =>
  workerController.createWorker(req, res, next)
);
router.get("/", (req, res, next) =>
  workerController.getAllWorkers(req, res, next)
);
router.patch("/:id/block-unblock", (req, res, next) =>
  workerController.blockOrUnblockWorker(req, res, next)
);
router.patch("/:id/availability", (req, res, next) =>
  workerController.updateWorkerAvailability(req, res, next)
);
